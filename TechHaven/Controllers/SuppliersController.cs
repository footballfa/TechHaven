...
namespace TechHaven.Controllers
{
    public class SuppliersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SuppliersID,SupplierName,SupplierContact,DeliveryTime")] Suppliers suppliers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SuppliersID,SupplierName,SupplierContact,DeliveryTime")] Suppliers suppliers)
        {
