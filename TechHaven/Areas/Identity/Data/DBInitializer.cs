...
namespace TechHaven.Areas.Identity.Data
{
    internal class DBInitializer
    {
            ...
            var Employees = new Employee[]
     {
                             ...
                             new Employee {EmployeeName = "Alex", EmployeeRole = "Receptionist", LoginCredentials = 3467 },
...
{
                            new OrderDetail {ProductsID=1,OrderID=1,ProductName = "iPhone 15 Pro Max", Quantaty = 1, Price = 2100},
                            new OrderDetail {ProductsID=2,OrderID=2,ProductName = "Xbox Series X", Quantaty = 1, Price = 950},
