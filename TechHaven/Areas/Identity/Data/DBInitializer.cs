    ...
    public class DBInitializer
    {
        internal static void Initialize(TechHavenContext context)
        {
            ...
            var customers = new Customer[]
            {
                ...
                new Customer { FirstName = "Mike", LastName = "Tyson", Email = "connorm1@gmail.com" },
                new Customer { FirstName = "Max", LastName = "farewel", Email = "connorm1@gmail.com" },
                new Customer { FirstName = "Jhon", LastName = "Jones", Email = "connorm1@gmail.com" },
                new Customer { FirstName = "David", LastName = "Hallen", Email = "connorm1@gmail.com" },
